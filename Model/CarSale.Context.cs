...
namespace CarSalesSystem.Model
{
    ...
    public partial class CARSALESSYSTEMEntities6 : DbContext
    {
        public CARSALESSYSTEMEntities6()
            : base("name=CARSALESSYSTEMEntities6")
        {
        }
        ...
        public virtual DbSet<EMPLOYEE_PAYMENT_DETAIL> EMPLOYEE_PAYMENT_DETAIL { get; set; }
