...
namespace CarSalesSystem.Admin.Pages
{
    ...
    public partial class Info : Page
    {
        ...
        public Info(/*EMPLOYEE _employee*/)
        {
            ...
            if(empinfo.LAST_CHECKIN_DATE != DateTime.Today)
            {
        ...
        {
            var empinfo = DataProvider.Ins.DB.EMPLOYEEs.Find(AccountInfo.IdAccount);
            empinfo.LAST_CHECKIN_DATE = DateTime.Today;
            empinfo.DATE_FROM_LAST_PAID += 1;
            DataProvider.Ins.DB.SaveChanges();
            notifier.ShowSuccess("Successfully check_in!");
            checkin_button.IsEnabled = false;
        }
    }
}
